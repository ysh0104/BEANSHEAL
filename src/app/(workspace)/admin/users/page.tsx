...
export default function UserManagementPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans pb-16">
      ...
      {/* 메인 데이터 테이블 */}
      <div className="max-w-[1600px] mx-auto px-4 md:px-6 mt-6 space-y-6 min-w-0">
        {/* 무채색 깔끔한 알림 메시지 토스트 */}
        {statusMsg && (
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-xs">
          <div className="px-5 py-4 bg-slate-50 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-t-2xl">
            <div>

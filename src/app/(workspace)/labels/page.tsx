...
export default function LabelPrinterPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 md:p-8 font-sans text-gray-900">
      
      {/* 화면용 UI (인쇄 시 숨김 처리됨: print:hidden) */}
      <div className="print:hidden mb-10 p-4 sm:p-6 bg-white border border-gray-300 rounded-lg shadow-sm">
        <h2 className="text-xl sm:text-2xl font-bold mb-6">QR 라벨 발행기</h2>

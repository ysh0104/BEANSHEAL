      ...
      <div className="flex items-center justify-between px-2 py-1 bg-slate-50 border-b border-gray-200 text-[11px]">
        <div className="flex items-center gap-1">
          <button
            ...
            className="px-1.5 py-0.5 rounded border border-gray-200 hover:bg-gray-100 text-gray-700 text-[10px] font-bold transition-colors cursor-pointer flex items-center gap-1"
          >
